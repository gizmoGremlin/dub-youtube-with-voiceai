...
/* ------------------------------------------------------------------ */
export async function stitchSegments(segmentPaths, outputPath) {
...
/*  Encode to mp3                                                      */
/* ------------------------------------------------------------------ */
export async function encodeToMp3(inputPath, outputPath) {
    try {
...
/* ------------------------------------------------------------------ */
export async function normalizeLoudness(inputPath, outputPath) {
    try {
...
export async function muxAudioVideo(opts) {
...
/* ------------------------------------------------------------------ */
export async function generateMuxScripts(videoPath, audioPath, outputPath, syncPolicy, outDir) {
